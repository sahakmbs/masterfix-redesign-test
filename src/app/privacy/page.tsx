      ...
      <Container className="max-w-4xl">
        <Reveal>
          <div className="rounded-[2px] border border-ink/10 bg-paper p-8 md:p-14">
            ...
            <p className="mt-3 text-sm text-charcoal/50">Last updated: September 2026</p>
            ...
            <div className="mt-10 space-y-8 text-charcoal/75 leading-relaxed">
              ...
              <section>
                <h2 className="font-display text-2xl text-ink">4. Form and Scheduling Providers</h2>
                <p className="mt-3">
              ...
              <section>
                <h2 className="font-display text-2xl text-ink">6. Data Security</h2>
                <p className="mt-3">
              ...
              <section>
                <h2 className="font-display text-2xl text-ink">7. Contact Us</h2>
                <p className="mt-3">
